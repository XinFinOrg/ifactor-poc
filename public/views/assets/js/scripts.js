/**
 * @Package: Admin Responsive Theme
 * @Since:  Admin 1.0
 * This file is part of Admin Responsive Theme.
 */
...
jQuery(function($) {
    ...
    /*--------------------------------
         Window Based Layout
     --------------------------------*/
    ADMIN_SETTINGS.windowBasedLayout = function() {
        var width = window.innerWidth;
        //console.log(width);

        if ($("body").hasClass("chat-open") || $("body").hasClass("sidebar-collapse")) {

            ADMIN_SETTINGS.mainmenuCollapsed();
    ...
    /*--------------------------------
         Window Based Layout
     --------------------------------*/
    ADMIN_SETTINGS.onLoadTopBar = function() {
    ...
    /*--------------------------------
        Viewport Checker
     --------------------------------*/
    ADMIN_SETTINGS.viewportElement = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    ADMIN_SETTINGS.breadcrumbAutoHidden = function() {
    ...
    /*--------------------------------
         Section Box Actions
     --------------------------------*/
    ADMIN_SETTINGS.sectionBoxActions = function() {
    ...
    /*--------------------------------
         Main Menu Scroll
     --------------------------------*/
    ADMIN_SETTINGS.mainmenuScroll = function() {
    ...
    /*--------------------------------
         Collapsed Main Menu
     --------------------------------*/
    ADMIN_SETTINGS.mainmenuCollapsed = function() {
    ...
    /*--------------------------------
         Main Menu
     --------------------------------*/
    ADMIN_SETTINGS.mainMenu = function() {
    ...
    /*--------------------------------
         Top Bar
     --------------------------------*/
    ADMIN_SETTINGS.pageTopBar = function() {
    ...
    /*--------------------------------
         Extra form settings
     --------------------------------*/
    ADMIN_SETTINGS.extraFormSettings = function() {
    ...
    /*--------------------------------
         DataTables
     --------------------------------*/
    ADMIN_SETTINGS.dataTablesInit = function() {
    ...
    /*--------------------------------
         Tocify
     --------------------------------*/
    ADMIN_SETTINGS.tocifyScrollMenu = function() {
    ...
    /*--------------------------------
         Full Calendar
     --------------------------------*/
    ADMIN_SETTINGS.uiCalendar = function() {
    ...
    /*--------------------------------
         iCheck
     --------------------------------*/
    ADMIN_SETTINGS.iCheck = function() {
    ...
    /*--------------------------------
         Custom Dropzone
     --------------------------------*/
    ADMIN_SETTINGS.customDropZone = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    ADMIN_SETTINGS.otherScripts = function() {
...
//                        $this.find('span').html(start.format(drp.format) + drp.separator + end.format(drp.format));
    ...
    /*--------------------------------
        IOS7 Switchery
     --------------------------------*/
    ADMIN_SETTINGS.ios7Switchery = function() {
     ...
     *****************************/
    $(document).ready(function() {
        ADMIN_SETTINGS.windowBasedLayout();
        ADMIN_SETTINGS.mainmenuScroll();
        ADMIN_SETTINGS.mainMenu();
        ADMIN_SETTINGS.mainmenuCollapsed();
        ADMIN_SETTINGS.pageTopBar();
        ADMIN_SETTINGS.otherScripts();
        ADMIN_SETTINGS.iCheck();
        ADMIN_SETTINGS.customDropZone();
        ADMIN_SETTINGS.extraFormSettings();
        ADMIN_SETTINGS.uiCalendar();
        ADMIN_SETTINGS.tocifyScrollMenu();
        ADMIN_SETTINGS.dataTablesInit();
        ADMIN_SETTINGS.breadcrumbAutoHidden();
        ADMIN_SETTINGS.sectionBoxActions();
        ADMIN_SETTINGS.viewportElement();
        ADMIN_SETTINGS.onLoadTopBar();
        ADMIN_SETTINGS.ios7Switchery();
    });
